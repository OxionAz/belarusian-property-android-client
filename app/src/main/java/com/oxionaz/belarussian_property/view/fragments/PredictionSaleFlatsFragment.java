...
@EFragment(R.layout.fragment_sale_flat_prediction)
public class PredictionSaleFlatsFragment extends BasePredictionFragment {

    @Inject
    Rest restService;

    @Inject
    PredictionSaleFlatsPresenter predictionSaleFlatsPresenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        predictionSaleFlatsPresenter.onCreate(this);
    }

    @AfterViews
    void ready(){
        adjustViews();
        getActivity().setTitle("Продажа квартир");
    }
    ...
    private void adjustViews(){
        ...
        ArrayAdapter<String> type_adapter = new ArrayAdapter<>(getContext(),
                ...
                new String[]{"", "каркасно-блочный", "кирпичный", "монолитный", "панельный",
                        "силикатные блоки", "блок-комнаты", "бревенчатый"});
    ...
    void getPrediction(){
        ...
        predictionSaleFlatsPresenter.gePrediction(parameters);
    }
    ...
    protected BasePropertyPresenter getPresenter() {
        return predictionSaleFlatsPresenter;
    }
}
