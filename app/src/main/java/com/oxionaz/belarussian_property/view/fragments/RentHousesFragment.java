...
import com.oxionaz.belarussian_property.view.activities.RentHousesSearchActivity_;
...
public class RentHousesFragment extends BasePropertyFragment {
    ...
    @Inject
    RentHousesPresenter rentHousesPresenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rentHousesPresenter.onCreate(this);
        mainActivityView = (MainActivityView) getActivity();
    }

    @AfterViews
    void ready(){
        getActivity().setTitle("Дома");
        ...
        propertyAdapter = new PropertyAdapter(new PropertyAdapter.PropertyViewHolder.ClickListener() {
            ...
            public void OnFavoriteButtonClicked(Integer favorite, int position) {
                if (favorite != null) {
                    rentHousesPresenter.deleteFavorite(propertyAdapter.getFavoriteByPosition(favorite));
                    propertyAdapter.deleteFavorite(favorite);
                } else {
                    rentHousesPresenter.saveFavorite(propertyAdapter.getItemByPosition(position));
                ...
                if (dy > 0 || dy < 0)
                {
                    ...
                    if (loadable)
                    {
                        if ( (visibleItemCount + pastVisiblesItems) >= totalItemCount)
                        {
                            ...
                            rentHousesPresenter.nextLoad(true);
                        }
                    }
                }
            }
        ...
        swipe_refresh.setOnRefreshListener(() -> rentHousesPresenter.updateList(false));
        rentHousesPresenter.firstLoad(true);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (preferencesHelper.getFragmentPreference("rent_houses", "date_asc")) {
            option_sort_date_asc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("rent_houses", "date_desc")) {
            option_sort_date_desc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("rent_houses", "price_asc")) {
            option_sort_price_asc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("rent_houses", "price_desc")) {
    ...
    public void onResume() {
        super.onResume();
        rentHousesPresenter.getFavoritesFromCache();
    }
    ...
    void sort_def() {
        option_sort_default.setChecked(true);
        preferencesHelper.setFragmentPreference("rent_houses", "date_asc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "date_desc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "price_asc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "price_desc", false);
        rentHousesPresenter.updateList(true);
    }

    @OptionsItem(R.id.option_sort_date_asc)
    void sort_date_asc() {
        option_sort_date_asc.setChecked(true);
        preferencesHelper.setFragmentPreference("rent_houses", "date_asc", true);
        preferencesHelper.setFragmentPreference("rent_houses", "date_desc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "price_asc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "price_desc", false);
        rentHousesPresenter.updateList(true);
    ...
    void sort_date_desc() {
        option_sort_date_desc.setChecked(true);
        preferencesHelper.setFragmentPreference("rent_houses", "date_asc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "date_desc", true);
        preferencesHelper.setFragmentPreference("rent_houses", "price_asc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "price_desc", false);
        rentHousesPresenter.updateList(true);
    }
    ...
    void sort_price_asc() {
        ...
        preferencesHelper.setFragmentPreference("rent_houses", "date_asc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "date_desc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "price_asc", true);
        preferencesHelper.setFragmentPreference("rent_houses", "price_desc", false);
        rentHousesPresenter.updateList(true);
    }
    ...
    void sort_price_desc() {
        ...
        preferencesHelper.setFragmentPreference("rent_houses", "date_desc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "price_asc", false);
        preferencesHelper.setFragmentPreference("rent_houses", "price_desc", true);
        rentHousesPresenter.updateList(true);
    }
    ...
    public void showPropertyInfo(PropertyItem item, boolean favorite) {
        Intent intent = new Intent(getContext(), RentHouseActivity_.class);
    ...
    public void startPropertySearch() {
        Intent intent = new Intent(getContext(), RentHousesSearchActivity_.class);
