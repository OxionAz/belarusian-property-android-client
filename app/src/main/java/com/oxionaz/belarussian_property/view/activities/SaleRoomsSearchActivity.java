...
@EActivity(R.layout.activity_sale_rooms_search)
public class SaleRoomsSearchActivity extends AppCompatActivity {
    ...
    @ViewById
    EditText ceiling_height_from, ceiling_height_to, square_useful_from,
    ...
    void search(){
        ...
        dataManager.saveParameters("sale_rooms", parameters);
