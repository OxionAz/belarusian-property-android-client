...
@EActivity(R.layout.activity_rent_houses_search)
public class RentHousesSearchActivity extends AppCompatActivity {
    ...
    @ViewById
    Switch heating, electricity, gas, water, sewer, prepayment, agent, thumb;

    @ViewById
    Spinner wall, roof;

    @ViewById
    ToggleButton view_1, view_2, view_3, term_1, term_2;

    @ViewById
    EditText max_man, levels_from, levels_to, square_from, square_to, square_useful_from,
    ...
    private void adjustViews(){
        ...
        region.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                request.addProperty("table_1", "rent_cottage_day");
                request.addProperty("table_2", "rent_cottage_long");
        ...
        ArrayAdapter<String> wall_adapter = new ArrayAdapter<>(this,
                ...
                new String[]{"Любой материал стен", "белый кирпич", "блочный", "деревянный",
                        "кирпич", "керамзитобетонный", "сруб", "блок газосиликатный",
    ...
    void search(){
        ...
        if (view_1.isChecked() || view_2.isChecked() || view_3.isChecked()) {
            ...
            if (view_3.isChecked()) views.add("агроусадьба");
        ...
        parameters.addProperty("max_man", String.valueOf(max_man.getText()));
        ...
        dataManager.saveParameters("rent_houses", parameters);
