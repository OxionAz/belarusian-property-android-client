...
@EActivity(R.layout.activity_sale_flats_search)
public class SaleFlatsSearchActivity extends AppCompatActivity {
    ...
    @ViewById
    Switch metro_near, floor_first, floor_last, agent, thumb;

    @ViewById
    Spinner metro_branch, plan, repair, balcony, wc, type;

    @ViewById
    ToggleButton rooms_1, rooms_2, rooms_3, rooms_4;
    ...
    EditText ceiling_height_from, ceiling_height_to, square_from, square_to, square_useful_from,
            ...
            price_from, price_to, psm_from, psm_to, modified_date_from, modified_date_to;
    ...
    private void adjustViews(){
        ...
        region.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                request.addProperty("table", "sale_flat");
    ...
    void search(){
        ...
        parameters.addProperty("psm_from", String.valueOf(psm_from.getText()));
        parameters.addProperty("psm_to", String.valueOf(psm_to.getText()));
        ...
        dataManager.saveParameters("sale_flats", parameters);
