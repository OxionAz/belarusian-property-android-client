...
public class SaleFlatsFragment extends BasePropertyFragment {
    ...
    @Inject
    SaleFlatsPresenter saleFlatsPresenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        saleFlatsPresenter.onCreate(this);
    ...
    void ready(){
        ...
        propertyAdapter = new PropertyAdapter(new PropertyAdapter.PropertyViewHolder.ClickListener() {
            ...
            public void OnFavoriteButtonClicked(Integer favorite, int position) {
                if (favorite != null) {
                    saleFlatsPresenter.deleteFavorite(propertyAdapter.getFavoriteByPosition(favorite));
                    propertyAdapter.deleteFavorite(favorite);
                } else {
                    saleFlatsPresenter.saveFavorite(propertyAdapter.getItemByPosition(position));
                ...
                if (dy > 0 || dy < 0)
                {
                    ...
                    if (loadable)
                    {
                        if ( (visibleItemCount + pastVisiblesItems) >= totalItemCount)
                        {
                            ...
                            saleFlatsPresenter.nextLoad(true);
                        }
                    }
                }
            }
        ...
        swipe_refresh.setOnRefreshListener(() -> saleFlatsPresenter.updateList(false));
        saleFlatsPresenter.firstLoad(true);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (preferencesHelper.getFragmentPreference("sale_flats", "date_asc")) {
            option_sort_date_asc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("sale_flats", "date_desc")) {
            option_sort_date_desc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("sale_flats", "price_asc")) {
            option_sort_price_asc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("sale_flats", "price_desc")) {
    ...
    public void onResume() {
        super.onResume();
        saleFlatsPresenter.getFavoritesFromCache();
    }
    ...
    void sort_def() {
        option_sort_default.setChecked(true);
        preferencesHelper.setFragmentPreference("sale_flats", "date_asc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "date_desc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "price_asc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "price_desc", false);
        saleFlatsPresenter.updateList(true);
    }

    @OptionsItem(R.id.option_sort_date_asc)
    void sort_date_asc() {
        option_sort_date_asc.setChecked(true);
        preferencesHelper.setFragmentPreference("sale_flats", "date_asc", true);
        preferencesHelper.setFragmentPreference("sale_flats", "date_desc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "price_asc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "price_desc", false);
        saleFlatsPresenter.updateList(true);
    ...
    void sort_date_desc() {
        option_sort_date_desc.setChecked(true);
        preferencesHelper.setFragmentPreference("sale_flats", "date_asc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "date_desc", true);
        preferencesHelper.setFragmentPreference("sale_flats", "price_asc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "price_desc", false);
        saleFlatsPresenter.updateList(true);
    }
    ...
    void sort_price_asc() {
        ...
        preferencesHelper.setFragmentPreference("sale_flats", "date_asc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "date_desc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "price_asc", true);
        preferencesHelper.setFragmentPreference("sale_flats", "price_desc", false);
        saleFlatsPresenter.updateList(true);
    }
    ...
    void sort_price_desc() {
        ...
        preferencesHelper.setFragmentPreference("sale_flats", "date_desc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "price_asc", false);
        preferencesHelper.setFragmentPreference("sale_flats", "price_desc", true);
        saleFlatsPresenter.updateList(true);
    }
    ...
    public void showPropertyInfo(PropertyItem item, boolean favorite) {
        Intent intent = new Intent(getContext(), SaleFlatActivity_.class);
    ...
    public void startPropertySearch() {
        Intent intent = new Intent(getContext(), SaleFlatsSearchActivity_.class);
