...
import com.oxionaz.belarussian_property.view.activities.RentRoomsSearchActivity_;
...
public class RentRoomsFragment extends BasePropertyFragment {
    ...
    @Inject
    RentRoomsPresenter rentRoomsPresenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rentRoomsPresenter.onCreate(this);
    ...
    void ready(){
        ...
        propertyAdapter = new PropertyAdapter(new PropertyAdapter.PropertyViewHolder.ClickListener() {
            ...
            public void OnFavoriteButtonClicked(Integer favorite, int position) {
                if (favorite != null) {
                    rentRoomsPresenter.deleteFavorite(propertyAdapter.getFavoriteByPosition(favorite));
                    propertyAdapter.deleteFavorite(favorite);
                } else {
                    rentRoomsPresenter.saveFavorite(propertyAdapter.getItemByPosition(position));
                ...
                if (dy > 0 || dy < 0)
                {
                    ...
                    if (loadable)
                    {
                        if ( (visibleItemCount + pastVisiblesItems) >= totalItemCount)
                        {
                            ...
                            rentRoomsPresenter.nextLoad(true);
                        }
                    }
                }
            }
        ...
        swipe_refresh.setOnRefreshListener(() -> rentRoomsPresenter.updateList(false));
        rentRoomsPresenter.firstLoad(true);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (preferencesHelper.getFragmentPreference("rent_rooms", "date_asc")) {
            option_sort_date_asc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("rent_rooms", "date_desc")) {
            option_sort_date_desc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("rent_rooms", "price_asc")) {
            option_sort_price_asc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("rent_rooms", "price_desc")) {
    ...
    public void onResume() {
        super.onResume();
        rentRoomsPresenter.getFavoritesFromCache();
    }
    ...
    void sort_def() {
        option_sort_default.setChecked(true);
        preferencesHelper.setFragmentPreference("rent_rooms", "date_asc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "date_desc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_asc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_desc", false);
        rentRoomsPresenter.updateList(true);
    }

    @OptionsItem(R.id.option_sort_date_asc)
    void sort_date_asc() {
        option_sort_date_asc.setChecked(true);
        preferencesHelper.setFragmentPreference("rent_rooms", "date_asc", true);
        preferencesHelper.setFragmentPreference("rent_rooms", "date_desc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_asc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_desc", false);
        rentRoomsPresenter.updateList(true);
    ...
    void sort_date_desc() {
        option_sort_date_desc.setChecked(true);
        preferencesHelper.setFragmentPreference("rent_rooms", "date_asc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "date_desc", true);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_asc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_desc", false);
        rentRoomsPresenter.updateList(true);
    }
    ...
    void sort_price_asc() {
        ...
        preferencesHelper.setFragmentPreference("rent_rooms", "date_asc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "date_desc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_asc", true);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_desc", false);
        rentRoomsPresenter.updateList(true);
    }
    ...
    void sort_price_desc() {
        ...
        preferencesHelper.setFragmentPreference("rent_rooms", "date_desc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_asc", false);
        preferencesHelper.setFragmentPreference("rent_rooms", "price_desc", true);
        rentRoomsPresenter.updateList(true);
    }
    ...
    public void showPropertyInfo(PropertyItem item, boolean favorite) {
        Intent intent = new Intent(getContext(), RentRoomActivity_.class);
    ...
    public void startPropertySearch() {
        Intent intent = new Intent(getContext(), RentRoomsSearchActivity_.class);
