...
import com.oxionaz.belarussian_property.view.activities.SaleHousesSearchActivity_;
...
public class SaleHousesFragment extends BasePropertyFragment {
    ...
    @Inject
    SaleHousesPresenter saleHousesPresenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        saleHousesPresenter.onCreate(this);
    ...
    void ready(){
        ...
        propertyAdapter = new PropertyAdapter(new PropertyAdapter.PropertyViewHolder.ClickListener() {
            ...
            public void OnFavoriteButtonClicked(Integer favorite, int position) {
                if (favorite != null) {
                    saleHousesPresenter.deleteFavorite(propertyAdapter.getFavoriteByPosition(favorite));
                    propertyAdapter.deleteFavorite(favorite);
                } else {
                    saleHousesPresenter.saveFavorite(propertyAdapter.getItemByPosition(position));
                ...
                if (dy > 0 || dy < 0)
                {
                    ...
                    if (loadable)
                    {
                        if ( (visibleItemCount + pastVisiblesItems) >= totalItemCount)
                        {
                            ...
                            saleHousesPresenter.nextLoad(true);
                        }
                    }
                }
            }
        ...
        swipe_refresh.setOnRefreshListener(() -> saleHousesPresenter.updateList(false));
        saleHousesPresenter.firstLoad(true);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (preferencesHelper.getFragmentPreference("sale_houses", "date_asc")) {
            option_sort_date_asc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("sale_houses", "date_desc")) {
            option_sort_date_desc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("sale_houses", "price_asc")) {
            option_sort_price_asc.setChecked(true);
        } else if (preferencesHelper.getFragmentPreference("sale_houses", "price_desc")) {
    ...
    public void onResume() {
        super.onResume();
        saleHousesPresenter.getFavoritesFromCache();
    }
    ...
    void sort_def() {
        option_sort_default.setChecked(true);
        preferencesHelper.setFragmentPreference("sale_houses", "date_asc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "date_desc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "price_asc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "price_desc", false);
        saleHousesPresenter.updateList(true);
    }

    @OptionsItem(R.id.option_sort_date_asc)
    void sort_date_asc() {
        option_sort_date_asc.setChecked(true);
        preferencesHelper.setFragmentPreference("sale_houses", "date_asc", true);
        preferencesHelper.setFragmentPreference("sale_houses", "date_desc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "price_asc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "price_desc", false);
        saleHousesPresenter.updateList(true);
    ...
    void sort_date_desc() {
        option_sort_date_desc.setChecked(true);
        preferencesHelper.setFragmentPreference("sale_houses", "date_asc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "date_desc", true);
        preferencesHelper.setFragmentPreference("sale_houses", "price_asc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "price_desc", false);
        saleHousesPresenter.updateList(true);
    }
    ...
    void sort_price_asc() {
        ...
        preferencesHelper.setFragmentPreference("sale_houses", "date_asc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "date_desc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "price_asc", true);
        preferencesHelper.setFragmentPreference("sale_houses", "price_desc", false);
        saleHousesPresenter.updateList(true);
    }
    ...
    void sort_price_desc() {
        ...
        preferencesHelper.setFragmentPreference("sale_houses", "date_desc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "price_asc", false);
        preferencesHelper.setFragmentPreference("sale_houses", "price_desc", true);
        saleHousesPresenter.updateList(true);
    }
    ...
    public void showPropertyInfo(PropertyItem item, boolean favorite) {
        Intent intent = new Intent(getContext(), SaleHouseActivity_.class);
    ...
    public void startPropertySearch() {
        Intent intent = new Intent(getContext(), SaleHousesSearchActivity_.class);
