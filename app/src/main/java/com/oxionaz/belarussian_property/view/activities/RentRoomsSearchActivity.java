...
@EActivity(R.layout.activity_rent_rooms_search)
public class RentRoomsSearchActivity extends AppCompatActivity {
    ...
    @ViewById
    Switch metro_near, neighbors, furniture, fridge, tv, washer, internet, floor_first, floor_last, prepayment, agent, thumb;

    @ViewById
    Spinner metro_branch, plan, repair, balcony, wc, beds, cooker, type;

    @ViewById
    ToggleButton term_1, term_2;

    @ViewById
    EditText ceiling_height_from, ceiling_height_to, square_useful_from, square_useful_to,
            kitchen_from, kitchen_to, floor_from, floor_to, total_floors_from,
    ...
    void search(){
        ...
        parameters.addProperty("neighbors", neighbors.isChecked() ? true : null);
        ...
        dataManager.saveParameters("rent_rooms", parameters);
